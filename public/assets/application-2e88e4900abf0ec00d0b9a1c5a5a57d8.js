...
(function() {
  window.markNavForBlogPosts = function() {
    return jQuery('a.anchorLink').parent().removeClass('active').last().addClass('active');
  };

}).call(this);
(function() {
  window.display_thanks_modal = function() {
    return jQuery('#thanks').modal('show');
  };
